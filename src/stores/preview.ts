...
export const previewLeafStore = writable<{ leaf: WorkspaceLeaf | null, filepath?: string | null } | null>(null)
export const isPreviewVisibleStore = writable(false);
export const isPreviewMaximizedStore = writable<boolean | null>(null);
